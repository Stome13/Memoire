    ...
    <section class="py-5">
      <div class="container-lg">
        <div class="row gy-4">
          ...
          // Séparer les pharmacies en garde et les autres
          $pharmaciesOnDuty = [];
          $pharmaciesOffDuty = [];
          ...
          foreach ($pharmacies as $pharmacie) {
            ...
            if ($gardeToday) {
              $pharmaciesOnDuty[] = $pharmacie;
            } else {
              $pharmaciesOffDuty[] = $pharmacie;
            }
          }
          
          // Fusionner avec pharmacies de garde en premier
          $pharmacies = array_merge($pharmaciesOnDuty, $pharmaciesOffDuty);
