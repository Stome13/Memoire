                ...
                <form id="step1Form" class="needs-validation" novalidate>
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <input type="text" class="form-control form-control-lg" id="lastName" placeholder="Dossou" required pattern="[a-zA-ZÀ-ÿ\s'-]+" title="Le nom ne doit contenir que des lettres, espaces, traits ou apostrophes" />
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control form-control-lg" id="adresse" placeholder="Dowa, Porto-Novo" rows="3"></textarea>
