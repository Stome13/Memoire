  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link logout-btn" href="#" onclick="showLogoutModal(); return false;">
  ...
  <div class="offcanvas-body p-0">
    ...
    <nav class="sidebar-nav-mobile">
      ...
      <div class="nav-section">
        ...
        <a href="?action=logout" class="sidebar-link logout-link" onclick="showLogoutModal(); return false;">
          <div class="link-icon">
...
<script src="../pharmacien/js/logout.js"></script>
